...
import { useHostairTestStore } from '../stores/hostair-test';
import { onMounted, ref, computed } from 'vue';
import GuestForm from '../components/GuestForm.vue';
import ConfirmationModal from '../components/ConfirmationModal.vue';

const { t } = useI18n();
const store = useHostairTestStore();
...
<template>
    ...
    <div v-if="store.bookings" class="min-h-screen bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <img src="/images/hostair-logo.png" alt="hostair" class="h-12 w-auto" />
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900">Hostair</h1>
                            <p class="text-sm text-gray-600">Guest Management System</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-8">
                        <a href="/guests" class="text-indigo-600 hover:text-indigo-800 font-medium transition">
                            Guest Library
                        </a>
        ...
        <ConfirmationModal ref="deleteModal" @confirm="confirmDeleteGuest" @cancel="guestToDelete = null" />
    </div>
</template>
