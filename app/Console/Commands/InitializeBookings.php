...
class InitializeBookings extends Command
{
    ...
    {
        $this->info('Deleting all existing bookings and guests...');

        // Delete guests first (cascade may not work with truncate)
        ...
        $this->info("Deleted {$guestCount} guest(s) and {$deletedCount} booking(s).");
        $this->newLine();
